...
export default function PracticalToolsPage() {
    ...
    return (
        <div className="space-y-10 pb-20 max-w-7xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
            {/* Header Banner */}
            <div className="bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 text-white rounded-[3rem] p-8 md:p-12 relative overflow-hidden shadow-2xl border border-white/10">
                ...
                <div className="relative z-10 max-w-3xl space-y-6">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/15 text-primary-light text-xs font-black uppercase tracking-widest backdrop-blur-md">
                        <Sparkles className="w-4 h-4 text-amber-400" /> Virtual Labs & Compilers
                    </div>
