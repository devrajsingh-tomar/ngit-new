...
const menuItems = [
  ...
  { label: "Typing Exams", href: "/student/typing", icon: Keyboard },
  {
    ...
    icon: Mic,
    subItems: [
      { label: "Steno Dashboard", href: "/steno/dashboard" },
      { label: "Practice Passages", href: "/steno/practice" },
      { label: "Dictation Player", href: "/steno/dictation" },
      { label: "Series Collections", href: "/steno/series" },
      { label: "Mock Tests", href: "/steno/mock-tests" },
      { label: "My Steno Tests", href: "/steno/my-tests" },
      { label: "Steno Leaderboard", href: "/steno/leaderboard" },
    ],
  },
