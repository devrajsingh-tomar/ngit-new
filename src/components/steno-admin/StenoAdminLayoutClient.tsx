...
import StenoAdminSidebar from "@/components/steno-admin/StenoAdminSidebar";
import StenoAdminNavbar from "@/components/steno-admin/StenoAdminNavbar";
import { cn } from "@/lib/utils";

export default function StenoAdminLayoutClient({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex h-screen bg-slate-50/50 overflow-hidden">
            ...
            <div className={cn(
                ...
                <StenoAdminSidebar onClose={() => setSidebarOpen(false)} className="h-full border-r border-slate-100" />
            </div>

            {/* Main Content Area */}
            <div className="flex flex-1 flex-col overflow-hidden w-full relative">
                <StenoAdminNavbar onMenuClick={handleMenuClick} />
